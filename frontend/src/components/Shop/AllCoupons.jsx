      ...
      {isLoading ? (
        ...
        <div className="w-full mx-8 pt-1 mt-10 bg-white">
          <div className="w-full flex justify-end">
            ...
            >
              <span className="text-white">Tạo mã phiếu giảm giá</span>
            </div>
          </div>
          <DataGrid
            rows={row}
                ...
                <form onSubmit={handleSubmit} aria-required={true}>
                  ...
                  <div>
                    <label className="pb-2">
                      Tên mã phiếu giảm giá<span className="text-red-500">*</span>
                    </label>
                    <input
                      type="text"
                      name="name"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="Nhập mã phiếu giảm giá có số tiền tối thiểu..."
                    />
                  </div>
                  <br />
                  <div>
                    ...
                    <input
                      ...
                      placeholder="Nhập mã phiếu giảm giá có số tiền tối đa.."
                    />
                  </div>
                  <br />
                  <div>
                    ...
                    >
                      <option value="Chọn sản phẩm cần giảm giá">
