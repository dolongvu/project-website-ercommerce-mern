 ...
 const minEndDate = startDate ? new Date(startDate.getTime() + 3 * 24 * 60 * 60 * 1000).toISOString().slice(0,10) : "";
  ...
  return (
    <div className="w-[90%] 800px:w-[50%] bg-white  shadow h-[80vh] rounded-[4px] p-3 overflow-y-scroll">
      <h5 className="text-[30px] font-Poppins text-center">Tạo tin tức</h5>
      {/* create event form */}
      <form onSubmit={handleSubmit}>
        ...
        <div>
          <label className="pb-2">
            Ngày kế thúc <span className="text-red-500">*</span>
          </label>
          <input
            type="date"
            name="price"
        ...
        <div>
          <label className="pb-2">
            Tải hình ảnh tin tức <span className="text-red-500">*</span>
          </label>
          <input
            type="file"
            name=""
