...
const WithdrawMoney = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    await axios
      ...
      .then((res) => {
        toast.success("Phương thức rút tiền được thêm thành công!");
        dispatch(loadSeller());
        setBankInfo({
          bankName: "",
          bankCountry: "",
  ...
  const deleteHandler = async () => {
    await axios
      ...
      .then((res) => {
        toast.success("Phương thức rút tiền đã xóa thành công!");
        dispatch(loadSeller());
      });
  };
  ...
  const availableBalance =  new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(seller?.availableBalance );
            ...
            {paymentMethod ? (
              <div>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="pt-2">
                    <label>
                    Mã ngân hàng Swift <span className="text-red-500">*</span>
                    </label>
                    <input
                      type="text"
                      name=""
                      ...
                      placeholder="Nhập mã số tài khoản Ngân hàng của bạn!"
                      className={`${styles.input} mt-2`}
                    />
                  </div>
                  ...
                  <div className="pt-2">
                    <label>
                    Tên chủ ngân hàng <span className="text-red-500">*</span>
                    </label>
                    <input
                      type="text"
                      name=""
                      ...
                      id=""
                      placeholder="Nhập tên Chủ ngân hàng của bạn!"
                      className={`${styles.input} mt-2`}
                    />
                  </div>
              ...
              <>
                ...
                {seller && seller?.withdrawMethod ? (
                  ...
                  <div>
                    ...
                    Không có phương thức rút tiền có sẵn!
                    </p>
