...
const ShopSettings = () => {
  ...
  const updateHandler = async (e) => {
    ...
    await axios.put(`${server}/shop/update-seller-info`, {
        ...
        toast.success("Thông tin cửa hàng được cập nhật thành công!");
        dispatch(loadSeller());
    }).catch((error)=> {
        toast.error(error.response.data.message);
    })
    ...
    <div className="w-full min-h-screen flex flex-col items-center">
      <div className="flex w-full 800px:w-[80%] flex-col justify-center my-5">
        ...
        >
          ...
          <div className="w-[100%] flex items-center flex-col 800px:w-[50%] mt-5">
            <div className="w-full pl-[3%]">
              <label className="block pb-2">Số điện thoại liên hệ</label>
            </div>
            <input
              type="number"
          ...
          <div className="w-[100%] flex items-center flex-col 800px:w-[50%] mt-5">
            <div className="w-full pl-[3%]">
              <label className="block pb-2">Mã Zip cửa hàng</label>
            </div>
            <input
              type="number"
