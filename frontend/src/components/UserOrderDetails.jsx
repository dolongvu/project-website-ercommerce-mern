    ...
    <div className={`py-4 min-h-screen ${styles.section}`}>
      ...
      {data &&
        data?.cart.map((item, index) => {
          ...
          <div className="w-full flex items-start mb-5">
            ...
            {!item.isReviewed && data?.status === "Gửi" ?  <div
          ...
          <div className="w-[50%] h-min bg-[#fff] shadow rounded-md p-3">
            ...
            <div className="w-full flex">
              ...
              <div>
                ...
                { new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(selectedItem?.discountPrice)} x {selectedItem?.qty} 
                </h4>
              </div>
            </div>
            ...
            <div className="w-full ml-3">
              ...
              <textarea
                ...
                placeholder="Sản phẩm này thế nào? Viết cảm nhận của bạn về nó!"
      ...
      <div className="w-full 800px:flex items-center">
        ...
        <div className="w-full 800px:w-[40%]">
          ...
          <h4>
            Trạng thái:{" "}
            {data?.paymentInfo?.status ? data?.paymentInfo?.status : "Không được thanh toán"}
          </h4>
          <br />
           {
            data?.status === "Gửi" && (
